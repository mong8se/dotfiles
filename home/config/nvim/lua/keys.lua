...
setKeyMap(
  "n",
  "-",
  [[:keeppatterns call search("^\\s*\\S", "be")<cr>]],
...
-- buffer
setKeyMap("n", "<leader>bb", fzf.buffers, { silent = true, desc = "List" })
...
setKeyMap(
  ...
  { silent = true, desc = "Zoom a buffer" }
)
setKeyMap(
  "n",
  "<leader>b/",
...
setKeyMap(
  "n",
  "<leader>ts",
  "<cmd>setlocal spell!<CR><cmd>set spell?<CR>",
  { silent = true, desc = "Toggle spell check" }
)
setKeyMap(
  "n",
  "<leader>tw",
  "<cmd>setlocal wrap!<CR><cmd>set wrap?<CR>",
  { silent = true, desc = "Toggle line wrap" }
)
setKeyMap(
  "n",
  "<leader>tp",
  "<cmd>setlocal paste!<CR><cmd>set paste?<CR>",
...
-- search
setKeyMap("n", "<leader>sl", fzf.live_grep, { desc = "Search live" })
setKeyMap("n", "<leader>*", fzf.grep_cword, { desc = "Search current word" })
setKeyMap("v", "<leader>*", fzf.grep_visual, { desc = "Search current word" })
setKeyMap(
  "n",
  "<leader>sf",
  fzf.lgrep_curbuf,
...
setKeyMap("n", "<leader>sr", fzf.resume, { desc = "Resume last search" })
